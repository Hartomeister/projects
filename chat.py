...
def start(message: types.Message):
    bot.send_message(message.chat.id, 'Для поиска собеседника напишите /find')
...
def find(message: types.Message):
    ...
    if message.chat.id not in users:
        ...
        bot.send_message(message.chat.id, 'Собеседник уже найден')
...
def stop(message: types.Message):
    ...
    if message.chat.id in users:
        bot.send_message(message.chat.id, 'Вы покинули беседу')
        bot.send_message(users[message.chat.id], 'Ваш собеседник вышел')
        ...
        bot.send_message(message.chat.id, 'Для начала найдите собеседника')
...
def chatting(message: types.Message):
    if message.chat.id in users:
        ...
        bot.send_message(message.chat.id, 'Для начала найдите собеседника! /find')
